...
Model::Model(ID3D11Device* dev, Model::PreMadeModels pm, float size, float hrep, float vrep)
{
	mDevice = dev;
	pStdVerts = nullptr;
	pTriList = nullptr;
	...
	case UnitPyramidRepTexture:
		ModelTools::UnitPyramidRepTexture(pStdVerts, numVerts, pTriList, numTris);
		break;
	case UnitSphere:
